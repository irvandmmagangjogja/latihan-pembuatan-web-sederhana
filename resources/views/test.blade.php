...
<body>
          ...
          <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              ...
              <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button type="button" class="deactivate-btn inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto">Deactivate</button>
    ...
    <script>
        // Fungsi untuk menangani klik pada tombol 'Deactivate'
        document.querySelector('.deactivate-btn').addEventListener('click', function() {
            alert('Akun akan dinonaktifkan. Proses ini tidak dapat dibatalkan.');
            // Tambahkan logika untuk deaktivasi akun di sini
        });
